...
<body>
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-right navbar-collapse" id="example">
					<ul class="nav navbar-nav">
						...
						<li class="active"><a href="Inventory.html" id="act">Inventory</a></li>
	...
	<div class="container">
		<button type="button" class="btn"  data-toggle="modal" data-target="#myModal" id="search">Add new item</button>
		...
		<!--POPUP MODALS FOR THE OPTIONS-->
			  	...
			  	<div class="modal-dialog">
				    <div class="modal-content">
				      	<div class="modal-header">
					        ...
					        <center><h4 class="modal-title" id="myModalLabel">New Item</h4></center>
				      	</div>
				      	<div class="modal-body">
					        	...
					        	<div class="row">
							        <div class='col-md-4'>
								        <div class="form-group">
								        	<label for="element1">Name of Item</label>
							...
							<div class="container">
					        	<div class="row">
							        <div class='col-md-4'>
								        <div class="form-group">
								        	<label for="element2">Quantity</label>
							...
							<div class="container">
					        	<div class="row">
							        <div class='col-md-4'>
								        <div class="form-group">
								        	<label for="datetimepicker1">Date Acquired</label>
			...
			&nbsp;&nbsp;
					<a href="Inventory.html" class="btn" id="search">View All</a>
		...
		<div class="container">
			<table class="table table-hover table-bordered">
				<tr id="tabletitle">
					<td><b>Recent Inventory</b></td>
				</tr>
				<tr id="names">
					<td><a href="">Brush</a></td>
				</tr>
				<tr id="names">
					<td><a href="">Medicines</a></td>
				</tr>
				<tr id="names">
					<td><a href="">Robes</a></td>
				</tr>
				<tr id="names">
